...
class MarketplaceWebServiceOrders_Client implements MarketplaceWebServiceOrders_Interface
{
    ...
    const MWS_CLIENT_VERSION = '2011-03-01';
   ...
   private function collapseWhitespace($s) {
    ...
    public function listOrders($request)
    {
		...
		$info = MarketplaceWebServiceOrders_Model_ListOrdersResponse::fromXML($this->_invoke($this->_convertListOrders($request)));
		//
		return $info;
	}
...
//                                $this->_pauseOnRetry(++$retries, $response['Status']);
    ...
    private function _signParameters(array $parameters, $key) {
        ...
        if (2 === $signatureVersion) {
            ...
            throw new InvalueArgumentException("Invalid Signature Version specified");
        }
