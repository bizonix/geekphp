<?php
	...
	//2、外网t测试环境
	//define('REQUEST_URL','https://t.api.cndirect.com/api.php');
	//define('CERT_ID',"server_sandbox-c7f4a4ed-7daa-48b9-87c4-a7d5d3c28eb9");


	//3、外网正式环境：
	define('REQUEST_URL','https://api.cndirect.com/api.php');
	...
	* 返回JSON数据
	*/	
	function CNOrderStatus($source_data){
